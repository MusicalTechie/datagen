...
#---
#- plotly_display_coredata_to_webserver.py
#---
...
# df = pd.read_csv('http://172.26.11.182/COREDATA_base.csv')

# ENABLED
# Get the data from a local path directly
df = pd.read_csv('C:/Apache/Apache24/cgi-bin/DataGen/data_results/base/COREDATA_base.csv')
