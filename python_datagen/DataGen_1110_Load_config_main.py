...
logging.debug("    - " + v_parm_current + " [" + v_parm_path_items_base_cstm + "]")
# ---
...
v_parm_path_items_delta_cstm = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_items_delta_cstm + "]")
# ---
...
logging.debug("    - " + v_parm_current + " [" + v_parm_path_items_merged_cstm + "]")
# ---
v_parm_current = "PATH_ITEMS_MERGED_NEW"
v_parm_path_items_merged_new = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_items_merged_new + "]")
...
logging.debug("    - " + v_parm_current + " [" + v_parm_path_organizations_base_cstm + "]")
# ---
...
logging.debug("    - " + v_parm_current + " [" + v_parm_path_organizations_delta_cstm + "]")
# ---
...
logging.debug("    - " + v_parm_current + " [" + v_parm_path_organizations_merged + "]")
# ---
v_parm_current = "PATH_ORGANIZATIONS_MERGED_NEW"
v_parm_path_organizations_merged_new = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_organizations_merged_new + "]")
...
logging.debug("    - " + v_parm_current + " [" + v_parm_path_customers_base_cstm + "]")
# ---
...
logging.debug("    - " + v_parm_current + " [" + v_parm_path_customers_delta_cstm + "]")
# ---
...
logging.debug("    - " + v_parm_current + " [" + v_parm_path_customers_merged_cstm + "]")
# ---
v_parm_current = "PATH_CUSTOMERS_MERGED_NEW"
v_parm_path_customers_merged_new = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_customers_merged_new + "]")
...
# ---
v_parm_current = "PATH_MATRIX_MERGED_NEW"
v_parm_path_matrix_merged_new = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_matrix_merged_new + "]")

# ---
v_parm_current = "PATH_PERIOD_TRACKER"
v_parm_path_period_tracker = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_period_tracker + "]")
...
# ---
v_parm_current = "PATH_COREDATA_MERGED_NEW"
v_parm_path_coredata_merged_new = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_coredata_merged_new + "]")
...
# ---
v_parm_current = "PATH_COREDATA2_MERGED_NEW"
v_parm_path_coredata2_merged_new = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_coredata2_merged_new + "]")
# ---
...
logging.debug("    - " + v_parm_current + " [" + v_parm_path_fbdi_booking + "]")
# ---
v_parm_current = "PATH_FBDI_BOOKING_NEW"
v_parm_path_fbdi_booking_new = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_fbdi_booking_new + "]")
# ---
v_parm_current = "PATH_FBDI_SHIPMENT"
v_parm_path_fbdi_shipment = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_fbdi_shipment + "]")
# ---
v_parm_current = "PATH_FBDI_SHIPMENT_NEW"
v_parm_path_fbdi_shipment_new = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_fbdi_shipment_new + "]")


# ---
v_parm_current = "PATH_MERGED"
v_parm_path_merged = v_parm_path_main + v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_path_merged + "]")
# ---
v_parm_current = "PATH_MERGED_BACKUP"
...
# ---
v_parm_current = "DG_DATE_PRESENT_DELTA"
v_parm_dg_date_present_delta = v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_date_present + "]")
# ---
...
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_legal_entity + "]")
# ---
v_parm_current = "DG_BUSINESS_UNIT"
v_parm_dg_business_unit = v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_business_unit + "]")
# ---
v_parm_current = "DG_ORG_MASTER"
v_parm_dg_org_master = v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_org_master + "]")
# ---
v_parm_current = "DG_ORG_PLANNING"
v_parm_dg_org_planning = v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_org_planning + "]")
# ---
...
# ---
v_parm_current = "DG_PERIOD_DELTA_ORGS_MIN"
v_parm_dg_period_delta_orgs_min = v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_period_delta_orgs_min + "]")
# ---
v_parm_current = "DG_PERIOD_DELTA_ORGS_MAX"
v_parm_dg_period_delta_orgs_max = v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_outcome_fix + "]")
# ---
v_parm_current = "DG_PERIOD_DELTA_ITEMS_MIN"
v_parm_dg_period_delta_items_min = v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_period_delta_orgs_max + "]")
# ---
v_parm_current = "DG_PERIOD_DELTA_ITEMS_MAX"
v_parm_dg_period_delta_items_max = v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_period_delta_items_max + "]")
# ---
v_parm_current = "DG_PERIOD_DELTA_CUST_MIN"
v_parm_dg_period_delta_cust_min = v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_period_delta_cust_min + "]")
# ---
v_parm_current = "DG_PERIOD_DELTA_CUST_MAX"
v_parm_dg_period_delta_cust_max = v_configParser[v_parm_group][v_parm_current]
logging.debug("    - " + v_parm_current + " [" + v_parm_dg_period_delta_cust_max + "]")
